  ...
  return (
    <main className={`course-page course-tone-${course.order}`} dir="ltr">
      ...
      <header className="course-topbar">
        ...
        <nav aria-label="Page navigation"><a href="#journey">Journey</a><a href="#parents">For parents</a><a href="#faq">Questions</a></nav>
      ...
      <section className="course-section course-faq-section" id="faq"><div className="course-section-heading"><span>Questions before enrolling</span><h2>Clear answers to help you decide.</h2></div><div className="course-faq-list">{course.faqsEn.map((item, index) => <details key={item.q} open={index === 0}><summary>{item.q}<i>+</i></summary><p>{item.a}</p></details>)}</div></section>
