  ...
  return (
    <main className={`course-page course-tone-${course.order}`} dir="ltr">
      ...
      <header className="course-topbar">
        <a href={sitePath(ENGLISH_PATH)} className="course-brand" aria-label="Kids Coding Hub — home"><img src={sitePath("/media/kids-coding-hub-logo.webp")} width="768" height="512" alt="Kids Coding Hub" decoding="async" /></a>
        ...
        <AnalyticsLink className="course-top-cta" href={whatsappUrl} source="course_topbar" params={{ page_language: "en", course_slug: course.slug }}>Ask about this level</AnalyticsLink>
      </header>
      <section className="course-hero">
        <div className="course-hero-copy">
          ...
          <div className="course-actions"><AnalyticsLink href={whatsappUrl} source="course_hero_assessment" params={{ page_language: "en", course_slug: course.slug }} className="course-button primary">Request a level assessment <ArrowIcon /></AnalyticsLink><a href="#journey" className="course-button ghost">See the learning journey</a></div>
      ...
      <section className="course-bottom-cta"><div><span>A clear first step, without pressure</span><h2>Share your learner’s age and interests, and we will confirm the right level before any enrolment.</h2><p>Ask Fatma about the available group, a suitable schedule, and the registration process.</p></div><AnalyticsLink href={whatsappUrl} source="course_bottom_assessment" params={{ page_language: "en", course_slug: course.slug }} className="course-button light">Request a level assessment <ArrowIcon /></AnalyticsLink></section>
