    ...
    <div className="kch-site" dir={ar ? "rtl" : "ltr"}>
      ...
      <footer className="site-footer">
        <div className="footer-main">
          ...
          <div className="footer-contact"><b>{ar ? "جاهزة للبداية؟" : "Ready to begin?"}</b><p>{ar ? "أرسلي العمر والهدف والدولة." : "Share the age, goal, and country."}</p><a href={waLink(parentMessage)} target="_blank" rel="noreferrer" onClick={() => trackWhatsApp("footer_whatsapp", language)}>WhatsApp<ArrowIcon /></a></div>
        </div>
